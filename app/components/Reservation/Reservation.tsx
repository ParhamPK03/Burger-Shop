...
const Reservation = () => {
  return (
    <div className='pt-[5rem] bg-center bg-cover relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url("/images/bg-black.jpg")]' id="Shop">
      {/* Overlay */}
      ...
      <div className="w-[80%] relative z-[20] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]">
        ...
        <div>
          <h1 className="text-[30px] md:text-[40px] lg:text-[50px] text-white font-bold leading-[3rem] md:leading-[4rem]">
            Do YOU HAVE ANY DINNER PLAN TODAY? RESERVE TABLE
          </h1>
          <p className="text-[17px] mt-[1rem] text-white text-opacity-50">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus,
            autem expedita. Praesentium nostrum labore soluta iusto totam.
            Ipsam, hic itaque dicta eius nesciunt laborum dolores?
          </p>
          <div className="flex mt-[2rem] items-center space-x-4">
            ...
            <div>
              ...
              <h1 className="text-yellow-300 font-bold text-[30px]">
                +012345678910
              </h1>
            </div>
          </div>
